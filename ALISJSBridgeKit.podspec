...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ALISJSBridgeKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xwwang_0102@qq.com/ALISJSBridgeKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xwwang_0102@qq.com' => 'xingwang.wxw@alibaba-inc.com' }
  s.source           = { :git => 'https://github.com/xwwang_0102@qq.com/ALISJSBridgeKit.git', :tag => s.version.to_s }
